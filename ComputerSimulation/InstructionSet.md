...
In the notation ```L, R1 [A,R2]``` means that second parameter could be address of register/index
...
```Compare Character String(CCS)```. The L, A1, and A2 fields are loaded into internal registers. A
loop is begun.
